...
def read_xyz(file, max_body=4, num_joint=25):  # 取了前两个body
    ...
    data = np.zeros((max_body, seq_info['numFrame'], num_joint, 3))#2,300,25,3
    for n, f in enumerate(seq_info['frameInfo']): #300
        for m, b in enumerate(f['bodyInfo']): #2
            for j, v in enumerate(b['jointInfo']): #25
    ...
    data = data.transpose(3, 1, 2, 0)#3,300,25,2
    return data
...
fig=plt.figure()
ax = Axes3D(fig)
pfp=np.zeros((3,300,25,2))
xyz, = ax.plot3D([],[],[])

f = -1
def update(f):
    global pfp
    link = [(1, 2), (2, 21), (3, 21), (4, 3), (5, 21), (6, 5), (7, 6),
                    (8, 7), (9, 21), (10, 9), (11, 10), (12, 11), (13, 1),
                    (14, 13), (15, 14), (16, 15), (17, 1), (18, 17), (19, 18),
                    (20, 19), (22, 23), (23, 8), (24, 25
                    ), (25, 12)]
    xx = 0
    yy = 1
    zz = 2
...
def testplt(fp):
    anim = FuncAnimation(fig, update, frames=np.arange(0, 300), blit=False ,interval=50)
    plt.show()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data/testout/')
