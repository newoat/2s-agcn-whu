...
def gdata(data_path, out_path):
    ...
    for filename in os.listdir(data_path):
        ...
        fn = 'S000C00' + str(int(video_id) % 4 + 1) + 'P001R001A' + str(1+action_idx).zfill(3)+ '_' + video_name + '.skeleton'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_folder', default='../data/ShakeFive_raw_train/')
